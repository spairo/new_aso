(function wrapper() {
	...
	angular
		.module('app')
		.factory('detailBlotterWarrantsService', detailBlotterWarrantsServiceFactory);

	function detailBlotterWarrantsServiceFactory(apiBuilder) {
		var service = {
			saveDeal: {
				method: 'post',
				url: '/blotter/warrant'
